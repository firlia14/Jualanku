...
if(isset($_POST['login'])){
    ...
    if($uname == '' or $paswd == ''){
        ...
        if($r1['username'] == ''){
            $err .= "<li>Username <b>$uname</b> tidak tersedia.</li>";
        }elseif($r1['password'] != ($paswd)){
            $err .= "<li>Password yang dimasukkan tidak sesuai.</li>";
        }       
        
        if(empty($err)){
            $_SESSION['session_username'] = $uname; //server
            $_SESSION['session_password'] = ($paswd);
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="loginform" class="form-horizontal" action="" method="post" role="form">       
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input id="login-username" type="text" class="form-control" name="username" value="<?php echo $uname ?>" placeholder="username">                                        
                    </div>
                    <div style="margin-bottom: 25px" class="input-group">
